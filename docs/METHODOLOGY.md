...
**Authors**: Noam & Shany  
**Project**: Personal Food Taste Classification using Transfer Learning
...
- **Size**: 200 personally labeled food images from Food101
- **Classes**: 
  - Disgusting: 37 images (18.5%)
  - Neutral: 84 images (42.0%)  
  - Tasty: 79 images (39.5%)
- **Split**: 60/20/20 → Train: 120, Validation: 40, Test: 40
...
**60/20/20 Split Strategy:**
- Train: 120 samples, Validation: 40 samples, Test: 40 samples
- Proper three-way validation methodology
- Stratified sampling ensures balanced class distribution
- Enables robust model selection and hyperparameter tuning
...
- Learning from extremely limited labeled data (200 samples)
...
### 3. Robust Validation Methodology
**Implementation**: Stratified 60/20/20 splitting for reliable evaluation
- **Advantage**: Proper validation prevents overfitting and enables model selection
- **Strategy**: Early stopping based on validation performance
- **Result**: Effective detection across all classes including minorities
...
|--------|-------|----------|
| **Test Accuracy** | 37.5% | Solid performance for subjective task |
| **Macro F1** | 0.356 | Balanced across classes |
| **Disgusting Recall** | 25.0% | Effective minority class detection |
| **Neutral Recall** | 41.2% | Most predictable class |
| **Tasty Recall** | 40.0% | Good quality pattern recognition |
| **Training Epochs** | 12 | Proper early stopping |

### Key Technical Findings

**1. Model Validation:**
- Proper train/validation/test methodology prevents overfitting
- Early stopping based on validation performance
- Consistent alignment across all data splits
